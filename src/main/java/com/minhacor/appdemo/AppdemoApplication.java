...
public class AppdemoApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Produto p3 = new Produto(null, "Mesa de escritorio", 80.00); 
		Produto p4 = new Produto(null, "Toalha", 50.00); 
		Produto p5 = new Produto(null, "Colcha", 200.00); 
		Produto p6 = new Produto(null, "Tv true color", 80.00); 
		Produto p7 = new Produto(null, "Rocadeira", 80.00); 
		Produto p8 = new Produto(null, "Abajour", 80.00); 
		Produto p9 = new Produto(null, "Pendente", 80.00); 
		Produto p10 = new Produto(null, "Mouse", 80.00); 
